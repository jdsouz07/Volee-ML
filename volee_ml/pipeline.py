...
It's just the steps one after another. Each step also runs on its own
...
STEPS = [
    ...
    ("2a. Tune the rating systems on the validation years", "volee_ml.tune"),
    ...
    ("6. Export the live demo's data", "volee_ml.export"),
]
